        ...
        public async Task GetFacebookData()
        {
            ...
            await request.GetResponseAsync().ContinueWith(t => {
                ...
                else
                {
                    ...
                    string name = (string)jo["first_name"];
                    string gender= (string)jo["gender"];
                    string locale = (string)jo["locale"];
                    string linkFB = (string)jo["link"];
                    string lastname = (string)jo["last_name"];
                    ...
                    App.Instance.userC = new UserC() { Email= email,
                        FirstName = name,
                        LastName = lastname,
                        PhotoUrl = pictureUrl,
                        Gender= gender,
